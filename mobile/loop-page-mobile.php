...
<?php if ( have_posts() ) { ?>
	<?php while ( have_posts() ) { 
		...
		if ( !empty($tbm_sub_pages) ) { ?>
			<?php echo boozurk_mobile_seztitle( 'before' ) . __( 'Child pages', 'boozurk' ) . boozurk_mobile_seztitle( 'after' ); ?>
			<ul class="tbm-group">
				<?php 
		...
		if ( $tbm_the_parent_page ) {?>
			<?php echo boozurk_mobile_seztitle( 'before' ) . __( 'Parent page', 'boozurk' ) . boozurk_mobile_seztitle( 'after' ); ?>
			<ul class="tbm-group">
