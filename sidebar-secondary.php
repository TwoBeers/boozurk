...
<div class="sidebar<?php echo ' ' . $boozurk_opt['boozurk_sidebar_secondary'] ?>" id="sidebar-secondary">
	<div class="inner">
...
<div class="secondary top-fade<?php echo ' ' . $boozurk_opt['boozurk_sidebar_secondary'] ?>"></div>

<?php if ( ! is_active_widget(false, false, 'bz-navbuttons', true) ) { ?>
	<?php boozurk_navbuttons(); ?>
<?php } else { ?>
<div class="secondary bottom-fade<?php echo ' ' . $boozurk_opt['boozurk_sidebar_secondary'] ?>"></div>
<?php } ?>
