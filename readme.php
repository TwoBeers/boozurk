...
<h3>ADVANCED THEME FEATURES:</h3>
	<ul>
		...
		<li><h4>Inline post expander</h4>
			<p>This feature converts the "more..." link (that usually redirects user to the complete view of post), in a dinamic expander, that shown the whole post content inline, without leaving the current page.</p>
		</li>
		<li><h4>Thickbox images and galleries</h4>
			...
			</br><u>Note:</u> the javascript code detects only images linked to the images itself, not to the attachment page.</p>
		</li>
		<li><h4>MP3 Audio player</h4>
			<p>A swf MP3 player for listening mp3 files even in browsers that don't support them.</p>
		</li>
		<li><h4>Cool tooltips</h4>
...
<h3 id="bz-cap-widgets">WIDGETS:</h3>
	...
	<ul>
		...
		<li><h4>Latest activity</h4>
			<p>A list of the last commented posts on your site.</p>
		</li>
		<li><h4>Latest comment authors</h4>
		...
		<li><h4>Follow Me</h4>
			...
			</br><u>Note:</u> the mail address will be javascript encripted to protect you from span.</p>
		</li>
		<li><h4>besides...</h4>
...
<h3>POST FORMATS:</h3>
	...
	<ul>
		...
		<li><h4>audio</h4>
			<p>the code will search for the first linked audio file ( .mp3, .ogg, .m4a ) inside the content. Make sure there's one, at least.</p>
		</li>
		<li><h4>chat</h4>
		</li>
		<li><h4>gallery</h4>
			<p>the code will search for all the images attached to the post. Make sure there's one, at least.</p>
		</li>
		<li><h4>image</h4>
			<p>the code will search for the first image (&lt;img&gt;) tag inside the content. Make sure there's one, at least.</p>
		</li>
		<li><h4>link</h4>
			<p>the code will search for the first anchor (&lt;a&gt;) tag inside the content. Make sure there's one, at least.</p>
		</li>
		<li><h4>quote</h4>
			<p>the code will search for the first quote (&lt;blockquote&gt;) tag inside the content. Make sure there's one, at least.</p>
		</li>
		<li><h4>status</h4>
		</li>
		<li><h4>video</h4>
	...
	<p>In <em>theme options</em> you can choose, for many of those formats, the title and the content to be shown in lists</p>
...
<h3>SUPPORT:</h3>
	<ul>
		...
		<li>code repository
			<ul>
				<li><a href="https://github.com/TwoBeers/boozurk" title="Boozurk on Github" target="_blank" >https://github.com/TwoBeers/boozurk</a></li>
			</ul>
		</li>
	</ul>
