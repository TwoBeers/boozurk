...
<!-- begin footer -->
			...
			<div id="footer">
				...
				<div id="bz-credits">&copy; <?php echo date( 'Y' ); ?>  <strong><?php bloginfo( 'name' ); ?></strong> <?php _e( 'All rights reserved','boozurk' ); ?><?php if ( $boozurk_opt['boozurk_tbcred'] == 1 ) { ?> - Powered by <a target="_blank" href="http://www.twobeers.net/" title="<?php esc_attr_e( 'Visit authors homepage','boozurk' ); ?> @ twobeers.net">Boozurk</a> and <a target="_blank" href="http://wordpress.org/" title="<?php esc_attr_e( 'Powered by WordPress','boozurk' ); ?>">WordPress</a><?php } ?><?php if ( ( !isset( $boozurk_opt['boozurk_mobile_css'] ) || ( $boozurk_opt['boozurk_mobile_css'] == 1) ) ) echo '<span class="hide_if_print"> - <a rel="nofollow" href="' . home_url() . '?mobile_override=mobile">'. __('Mobile View','boozurk') .'</a></span>'; ?></div>
