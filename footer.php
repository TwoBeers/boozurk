...
<!-- begin footer -->
			...
			<div id="footer">
				...
				<div id="bz-credits">&copy; <?php echo date( 'Y' ); ?>  <strong><?php bloginfo( 'name' ); ?></strong> <?php _e( 'All rights reserved','boozurk' ); ?> - Powered by <a target="_blank" href="http://wordpress.org/" title="<?php _e( 'Powered by WordPress','boozurk' ); ?>">WordPress</a><?php if ( $boozurk_opt['boozurk_tbcred'] == 1 ) { ?> and <a target="_blank" href="http://www.twobeers.net/" title="<?php _e( 'Visit authors homepage','boozurk' ); ?> @ twobeers.net">Boozurk</a><?php } ?><?php if ( ( !isset( $boozurk_opt['boozurk_mobile_css'] ) || ( $boozurk_opt['boozurk_mobile_css'] == 1) ) ) echo '<span class="hide_if_print"> - <a rel="nofollow" href="' . home_url() . '?mobile_override=mobile">'. __('Switch to Mobile View','boozurk') .'</a></span>'; ?></div>
