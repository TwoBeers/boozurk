...
boozurkFontResize = {
	...
	init : function () {
		...
		var savedSize = boozurkFontResize.cookie('fontSize');
		...
		$('.fontresizer_plus').click(function() {
			...
			boozurkFontResize.cookie('fontSize', newFontSize);
		});
		$('.fontresizer_reset').click(function() {
			baseElement.css("font-size",startFontSize);
			boozurkFontResize.cookie('fontSize', startFontSize);
		});
...
$(document).ready(function($){ boozurkFontResize.init(); });
